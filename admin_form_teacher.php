...
<body>
    <div class="container">
        <div class="pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Welcome FPT BTEC</h1>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='admin_edit_teacher.php?id=".$row['teacher_id']."' class='btn btn-primary'style='background-color: #F6702E; border-color: #F6702E;'>Edit</a>
                                <button class='btn btn-danger' onclick='confirmDelete(".$row['teacher_id'].")'style='background-color: #F6702E; border-color: #F6702E;'>Delete</button>
                              </td>";
                        echo "</tr>";
                    }
                } else {
